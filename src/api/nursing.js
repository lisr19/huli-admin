...
// 服务耗材列表
export function findServiceConsume(params) {
  return fetch('consumables/list', params)
}

// 服务耗材添加
export function doServiceConsumeAdd (params) {
  return post('consumables/add', params)
}

// 服务耗材编辑
export function doServiceConsumeEdit (params) {
  return patch('consumables/update', params)
}

// 服务耗材删除
export function doServiceConsumeDel (params) {
  return del('consumables/del', params)
}

// 服务耗材删除(多个)
export function doServiceConsumeDelMany (params) {
  return del('consumables/deleteMany', params)
}
