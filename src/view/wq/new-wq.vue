    ...
    return {
      ...
      detalColumns:[
...

        {
          ...
          render: (h, params) => {
            return h('span', [
              params.row.answer1 === 1 ? '发热（≥37.3℃）' : '体温正常 '
            ])
          }
        },
        {
        ...
        {
          title: '就诊患者14天内有到过以下地方吗？',
          align: 'center',
          key: 'answer3',
          render: (h, params) => {
            let hasArr = []
            if(params.row.answer3.include('0')){
              return h('span', '都没有')
            }
            if(params.row.answer3.include('1')){
              hasArr.push('湖北或武汉 ')
              return h('span', hasArr)
            }
            if(params.row.answer3.include('2')){
              hasArr.push('国（境）外 ')
              return h('span', hasArr)
            }
            if(params.row.answer3.include('3')){
              hasArr.push('其他明确的新冠肺炎疫区')
              return h('span', hasArr)
            }
          }
        },
        {
          title: '如果有,请填写具体国家和地区',
          align: 'center',
          key: 'answer31',
        },
        {
          title: '就诊患者14天内接触过来自湖北、武汉，或境内其他有病例报告社区的发热或有呼吸道症状的患者？',
          align: 'center',
          key: 'answer4',
          render: (h, params) => {
            return h('span', [
        ...
        {
          title: '就诊患者14天内接触过新冠肺炎确诊病例、疑似病例和无症状感染者吗？',
          align: 'center',
          key: 'answer5',
          render: (h, params) => {
            return h('span', [
        ...
        {
          title: '就诊患者14天内有无小范围内（如家庭、办公室、学校班级、车间等场所）出现2例及以上发热或呼吸道症状的病例？',
          align: 'center',
          key: 'answer7',
          render: (h, params) => {
            return h('span', [
              params.row.answer7 === 1 ? '是' : '否'
            ])
          }
        },
        {
          ...
          render: (h, params) => {
            return h('span', [
              params.row.answer8 === 1 ? '是（如有隐瞒，将承担法律责任）' : '否'
            ])
          }
        },
        {
